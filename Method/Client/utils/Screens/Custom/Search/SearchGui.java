...
public final class SearchGui extends GuiScreen {
   private SearchGui.ListGui listGui;
   private SearchGui.ListGui Allblocks;
   ...
   public void func_73866_w_() {
      this.listGui = new SearchGui.ListGui(this.field_146297_k, this, SearchGuiSettings.getBlockNames(), 500, 0);
      this.Allblocks = new SearchGui.ListGui(this.field_146297_k, this, SearchGuiSettings.getAllBlockNames(SearchGuiSettings.getBlockNames()), 0, 0);
   ...
   protected void func_146284_a(GuiButton button) throws IOException {
      if (button.field_146124_l) {
         ...
         case 3:
            ...
            Module Search = ModuleManager.getModuleByName("Search");
            if (Search.isToggled()) {
   ...
   protected void func_73869_a(char typedChar, int keyCode) throws IOException {
      ...
      if (!this.blockNameField.func_146179_b().isEmpty()) {
         this.Allblocks.list = SearchGuiSettings.SearchBlocksAll(SearchGuiSettings.getBlockNames(), this.blockNameField.func_146179_b());
      } else {
         this.Allblocks.list = SearchGuiSettings.getAllBlockNames(SearchGuiSettings.getBlockNames());
      }
   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
      this.func_146276_q_();
      this.func_73732_a(this.field_146297_k.field_71466_p, "Search (" + this.listGui.getSize() + ")", this.field_146294_l / 2, 12, 16777215);
