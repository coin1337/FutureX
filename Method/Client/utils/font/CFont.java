...
public class CFont {
   ...
   public static void setupfont() {
      ifontRenderer18 = new CFontRenderer(new Font("Impact", 0, 18), true, false);
      tfontRenderer18 = new CFontRenderer(new Font("Times New Roman", 0, 18), true, false);
      afontRenderer18 = new CFontRenderer(new Font("Arial", 0, 18), true, false);
      ifontRenderer22 = new CFontRenderer(new Font("Impact", 0, 22), true, false);
      tfontRenderer22 = new CFontRenderer(new Font("Times New Roman", 0, 22), true, false);
      afontRenderer22 = new CFontRenderer(new Font("Arial", 0, 22), true, false);
      ifontRenderer26 = new CFontRenderer(new Font("Impact", 0, 26), true, false);
      tfontRenderer26 = new CFontRenderer(new Font("Times New Roman", 0, 26), true, false);
      afontRenderer26 = new CFontRenderer(new Font("Arial", 0, 26), true, false);
   }

   public void setFontS(String Name, double size, CFontRenderer font) {
